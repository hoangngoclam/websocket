...
let messageClass = new message_class_1.default();
class RouteReceiveMessage {
    constructor() {
    }
    message(websocketClass, player, message) {
        let data;
        try {
        ...
        this.socketController = new socket_controller_1.default(websocketClass, player, data);
        switch (data.type) {
            case "SEND_ALL_USER":
...
exports.RouteReceiveMessage = RouteReceiveMessage;
